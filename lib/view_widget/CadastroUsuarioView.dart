...
import 'package:hora_do_remedio/model/UsuarioModel.dart';
...
class _CadastroUsuarioViewState extends State<CadastroUsuarioView> {
  ...
  TextEditingController _controllerNome = TextEditingController(text: "Sérgio Barboza");
  TextEditingController _controllerEmail = TextEditingController(text: "sfbarboza82@gmail.com");
  ...
  _cadastrarUsuario( UsuarioModel usuario ){
